...
namespace DS.BLL.DSWS
{
    public  class AddPresidentSpeechEntry
    {
        ...
        public List<AddPresidentEntities> getPresidentSpeechData250()
        {
            sql = " select TOP(1) PSL,SUBSTRING(Pspeech,0,500) as Pspeech,PresidentName,ImagePath  from WSPresidentSpeech order by PSL desc";
            dt = new DataTable();
            List<AddPresidentEntities> ListEntities = new List<AddPresidentEntities>();
            dt = CRUD.ReturnTableNull(sql);
            if (dt != null)
        ...
        public List<AddPresidentEntities> getPrincipalSpeechData250()
        {
            sql = "select TOP(1) PrinSL,SubString(Prinspeech,0,500) as Prinspeech,PrincipalName,ImagePath from WSPrincipalSpeech order by PrinSL desc";
            dt = new DataTable();
            List<AddPresidentEntities> ListEntities = new List<AddPresidentEntities>();
            dt = CRUD.ReturnTableNull(sql);
            if (dt != null)
