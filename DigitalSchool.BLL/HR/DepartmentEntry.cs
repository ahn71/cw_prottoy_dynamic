...
namespace DS.BLL.HR
{
    public class DepartmentEntry : IDisposable
    {
        ...
        public bool Insert()
        {
            sql = string.Format("INSERT INTO [dbo].[Departments_HR] " +
        ...
        public bool Update()
        {
            sql = string.Format("UPDATE [dbo].[Departments_HR] SET " +
        ...
        public List<DepartmentEntities> GetEntitiesData()
        {
            ...
            sql = string.Format("SELECT [DId],[DName],[DStatus],[IsTeacher] FROM [dbo].[Departments_HR]");
        ...
        public static void GetDepartmentlist(DropDownList dl)
        {
            DepartmentEntry dept = new DepartmentEntry();
            if (deptList == null)
            {
