<%@ Page Title="Salary Information" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SetSalary.aspx.cs" Inherits="DigitalSchool.SetSalary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate><p class="message"  id="lblMessage" clientidmode="Static" runat="server"></p>
            ...
            <div class="main_box">
            	<table width="978" border="0">
                    ...
                    <td class="level_col_3">                     
                        ...
                        <label style="margin-left:5px;" for="rdoScale">On Scale Paymetn</label>
                    </td>
                  </tr>
...
<div style="bottom: 0px; height: auto; width: 165px;  padding: 5px; text-align: center; background-color: rgba(0, 168, 0, 0.6); border: 1px solid green; margin-left: 240px; float: left; left: 0px; margin-right: 40px; margin-top: 5px;">
...
<input type="button" class="blackBtn" value="Clear" onclick="clearIt();" />
   ...
   <%-- <script src="/Scripts/adviitJS.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        //    $('#txtSchoolSalary').keyup(function () {
        //        var govSalary = $('#txtSchoolSalary').val();
              
        //       $('#lblTotalSalary').html($('#txtSchoolSalary').val());
