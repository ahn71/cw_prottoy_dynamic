<%@ Page Title="Employee View" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeView.aspx.cs" Inherits="DigitalSchool.Forms.EmployeeView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div class="reg_wrapper">
    	...
    	<div class="box">
        	<h1>Employee Information<span class="edit_button"><a href="#"><img src="images/file-edit.png" alt="" /></a></span> </h1>
            <div class="main_box">
    	...
    	<div class="box-3">
        	<h1>Academic Information<span class="edit_button"><a href="#"><img src="images/file-edit.png" alt="" /></a></span> </h1>
            <div class="main_box">
            	<table width="978" border="0">
                  <tr>
          ...
          <div class="box-2">
        	<h1>Employee Address <span class="edit_button"><a href="#"><img src="images/file-edit.png" alt="" /></a></span> </h1>
            <div class="main_box">
            	<table width="978" border="0">
                  <tr>
        ...
        <asp:Button ID="btnBack" runat="server" Text="Back" PostBackUrl="/Forms/TeacherPartialInfo.aspx" />
