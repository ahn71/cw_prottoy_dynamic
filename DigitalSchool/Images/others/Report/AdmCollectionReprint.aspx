<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmCollectionReprint.aspx.cs" Inherits="DS.Report.AdmCollectionReprint" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admission Collection Reprint</title>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        <div style="width: 595.28px; height: 841.89px; margin: 0 auto">
            ...
            <asp:Label runat="server" ID="lblStName" ClientIDMode="Static"></asp:Label><p style="float:right;margin-top:0px;border:1px solid">
                Reprint
            </p> <p style="float:right;margin-top:0px;border:1px solid">
