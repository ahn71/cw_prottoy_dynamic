<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollectionSummaryReport.aspx.cs" Inherits="DS.Report.CollectionSummaryReport" %>
...
<body>
    <form id="form1" runat="server">
        <div style="width: 595.28px; height: 841.89px; margin: 0 auto">
            ...
            <hr />
            <p style="text-align: center; margin: 0px;">Collection Summary Report 
            ...
            <hr />
            <div id="divCollectionSummary" runat="server" class="datatables_wrapper" 
        ...
        <script type="text/javascript">
            ...
            function goBack() {
                window.location = '/Forms/CollectionDetails.aspx?back=' + "csr";
            }
        </script>
    </form>
</body>
