    ...
    <div class="container">
        <form id="form1" class="form-signin" runat="server">
			...
			<div class='image_div2 right2'><img src="Images/Osis_right.jpg" />
                ...
                <div class='middleImg'>
            <h2 class="form-signin-heading">Sign in ODEMS<br />
                <div style="margin-top:25px">
                <asp:RadioButtonList Visible="false"  ID="rblUserType" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="radioButtonList" >
                <asp:ListItem Text="Admin" Value="Faculty" Selected="True" ></asp:ListItem>
                <asp:ListItem Text="Guide Teacher" Value="Adviser" ></asp:ListItem>
            ...
            <div  class="login-wrap">
                ...
                <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-lg btn-login btn-block" Text="Sign in" OnClientClick="return validateLogIn();"
                                    OnClick="btnLogin_Click" />
                <div runat="server" visible="false">
                <center> <a style="color:#49709d" href="Index.aspx">Back To Website</a></center>
                <div class="row">
