<%@ Page Title="Attendance Sheet Generate" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AttendanceSheetGenerate.aspx.cs" Inherits="DS.Forms.AttendanceSheetGenerate" %>
    ...
    <asp:UpdatePanel runat="server" ID="updatepanelFeesSett">
        <ContentTemplate>
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p class="text-right">Attendance Sheet List</p>
                    </div>
                        ...
                        <div class="tgPanel">
                            ...
                            <table class="tbl-controlPanel">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="dlClass" runat="server" Height="26px" Width="293px" AutoPostBack="True"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:UpdatePanel runat="server" ID="up1">
                                            ...
                                            <ContentTemplate>
                                                <asp:DropDownList ID="dlSection" runat="server" Height="26px" Width="293px"></asp:DropDownList>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
