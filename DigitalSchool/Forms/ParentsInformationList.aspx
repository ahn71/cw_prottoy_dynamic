<%@ Page Title="Parents Information List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ParentsInformationList.aspx.cs" Inherits="DS.Forms.ParentsInformationList" %>
                ...
                <ContentTemplate>
                    <table>
                        <tr>
                            <td>Batch</td>
                            <td>
                                <asp:DropDownList ID="dlBatchName" Style="width: 120px;" runat="server"
                                    ClientIDMode="Static" AutoPostBack="false">
                                </asp:DropDownList>
                            </td>
                            <td>Section</td>
                            <td>
                                <asp:DropDownList ID="dlSection" Style="width: 120px;" runat="server"
                                    ClientIDMode="Static" AutoPostBack="false">
                            ...
                            <td>Shift</td>
                            <td>
                                <asp:DropDownList ID="dlShift" Style="width: 120px;" runat="server"
                                    ClientIDMode="Static" AutoPostBack="false">
                                    <asp:ListItem>All</asp:ListItem>
