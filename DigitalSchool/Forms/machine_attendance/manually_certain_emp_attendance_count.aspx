<%@ Page Title="Faulty and staff Manually Attendance Entry" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="manually_certain_emp_attendance_count.aspx.cs" Inherits="DS.Forms.machine_attendance.manually_certain_emp_attendance_count" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Always" runat="server">
        ...
        <ContentTemplate>
            <div class="container">
                <div class="tgPanel">
                    <div class="tgPanelHead">Certain Faculty/Staff Attendance Entry</div>
                    <table class="tbl-controlPanel">
                        <tr>
                            <td>Count Type
                            </td>
                            <td>
                                <asp:RadioButtonList ClientIDMode="Static" CssClass="" ID="rblAttendanceCountType"
                                    runat="server" RepeatDirection="Horizontal" AutoPostBack="True"
                                    OnSelectedIndexChanged="rblAttendanceCountType_SelectedIndexChanged">
                        ...
                        <tr id="trToDate" runat="server">
                            ...
                            <td>
                                <asp:TextBox ID="txtToDate" runat="server" ClientIDMode="Static" CssClass="input controlLength"
                                    PlaceHolder="Click For Calendar"></asp:TextBox>asp:TextBox>
