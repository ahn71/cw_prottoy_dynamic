<%@ Page Title="Data Import" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="import_data.aspx.cs" Inherits="DS.Forms.machine_attendance.import_data" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tgPanel" style="width: 830px;">
                            <div class="tgPanelHead">Student Attendance Import</div>
                        </div>
                    </div>
                    <div class="col-md-6">
