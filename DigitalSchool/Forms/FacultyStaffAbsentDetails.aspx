<%@ Page Title="Staff Or Faculty Absent Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FacultyStaffAbsentDetails.aspx.cs" Inherits="DS.Forms.FacultyStaffAbsentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
    ...
    <div class="container">
        <div class="row">
            <div class="tgPanel">
                <div class="tgPanelHead">Faculty and Staff Absent Details</div>
