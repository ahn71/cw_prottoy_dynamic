<%@ Page Title="Current Student Information" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CurrentStudentInfo.aspx.cs" Inherits="DS.Forms.CurrentStudentInfo" %>
        ...
        <div class="tgInput" style="width: 680px; margin: 20px auto;">
            <table>
                <tr>
                    ...
                    <td>Section</td>
                    <td>
                        <asp:DropDownList ID="dlSection" runat="server" Style="width: 120px;">
                            <asp:ListItem>All</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>Shift</td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function editStudent(studentId) {
            goURL('/Forms/CurrentStudentUpdate.aspx?StudentId=' + studentId + "&Edit=True");
        }
        function viewStudent(studentId) {
            goURL('/Forms/CurrentStudentView.aspx?StudentId=' + studentId);
        }
