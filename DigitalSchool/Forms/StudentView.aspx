<%@ Page Title="Student Profile View" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentView.aspx.cs" Inherits="DS.Forms.StudentView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <link href="/Styles/reg_style.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="reg_wrapper">
        <asp:Button runat="server" ID="btnPrintpreview" Text="Print Preview" Width="110px" OnClick="btnPrintpreview_Click" CssClass="greenBtn" />
        <asp:Button ID="btnBack" runat="server" Text="Back" PostBackUrl="/Forms/AdmissionDetails.aspx" CssClass="blackBtn" />
        <div class="box">
        ...
        <div class="box-2">
            <h1>Permanent address <span class="edit_button"><a href="#">
                <img src="images/file-edit.png" alt="" /></a></span> </h1>
            <div class="main_box">
                <table width="978" border="0">
                    <tr>
        ...
        <div class="box-3">
            ...
            <div class="main_box">
                <table width="978" border="0">
                    ...
                    <tr>
                        <td class="level_col">Registration </td>
                        <td class="level_col_2">:</td>
                        <td class="level_col_3">
                            <asp:Label ID="lblRegistrationPSCJSC" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
