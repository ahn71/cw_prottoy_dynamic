<%@ Page Title="Attendance Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AbsentDetails.aspx.cs" Inherits="DS.Forms.AbsentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="tgPanel">
                <div class="tgPanelHead">Absent Details</div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button runat="server" ID="btnDateRangeSearch" Text="Search" CssClass="btn btn-success litleMargin"
                                ClientIDMode="Static" OnClick="btnDateRangeSearch_Click" />
                        </td>
                    </tr>
                </table>
