<%@ Page Title="Student List" Language="C#" MasterPageFile="~/main.Master"  AutoEventWireup="true" CodeBehind="StudentList.aspx.cs" Inherits="DS.UI.Reports.Students.StudentList" %>
                            ...
                            <div class="form-inline">
                                 ...
                                 <div class="form-group">
                                     <label for="exampleInputName2">Shift</label>
                                        <asp:DropDownList ID="dlShift" runat="server" ClientIDMode="Static" CssClass="form-control kk"
                                            AutoPostBack="false">
                                ...
                                <div class="form-group">
                                     <label for="exampleInputName2">Class</label>
                                        <asp:DropDownList ID="ddlClass" runat="server" ClientIDMode="Static" CssClass="form-control kk"
                                ...
                                <div class="form-group">
                                     <label for="exampleInputName2">Section</label>
                                        <asp:DropDownList ID="dlSection" runat="server" ClientIDMode="Static" CssClass="form-control kk"
                                            AutoPostBack="false">
                                            <asp:ListItem Value="00">All</asp:ListItem>
                                        </asp:DropDownList>
                                 </div>
        ...
        <div class="widget">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    ...
                    <div id="divStudentList" class="datatables_wrapper" runat="server"
