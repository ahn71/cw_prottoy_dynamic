<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master"  AutoEventWireup="true" CodeBehind="GuardianContactList.aspx.cs" Inherits="DS.UI.Reports.Students.GuardianContactList" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">               
                ...
                <li class="active">Gurdian Contact List</li>               
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>  
        ...
        <div class="widget">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    ...
                    <div id="divGuardianContractList" class="datatables_wrapper" runat="server" style="width: 100%; height: auto"></div>
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </div>
