<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="GenderwiseStdList.aspx.cs" Inherits="DS.UI.Reports.Students.GenderwiseStdList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">               
                ...
                <li class="active">Gender Student List</li>               
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>   
    ...
    <div class="tgPanel">
        <asp:UpdatePanel runat="server" ID="upcws">
            ...
            <ContentTemplate><div class="row tbl-controlPanel"> 
                    ...
                    <div class="form-inline">
                        ...
                        <div class="form-group">
                           <label for="exampleInputName2">Batch</label>
                            <asp:DropDownList ID="dlBatch" runat="server" CssClass="input controlLength form-control"
                               OnSelectedIndexChanged="dlBatch_SelectedIndexChanged"  ClientIDMode="Static" AutoPostBack="true">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           <label for="exampleInputName2">Gender</label>
                            <asp:DropDownList ID="dlGender" runat="server" CssClass="input controlLength form-control"
                                ClientIDMode="Static" AutoPostBack="false">
                                <asp:ListItem>All</asp:ListItem>
