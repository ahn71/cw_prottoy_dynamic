<%@ Page Title="" MasterPageFile="~/main.Master" Language="C#" AutoEventWireup="true" CodeBehind="DepartmentwiseReport.aspx.cs" Inherits="DS.UI.Reports.StafforFaculty.SubjectwiseTeacherList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
        ...
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">               
                ...
                <li class="active">Department Wise List</li>               
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>  
            ...
            <ContentTemplate>
                <table class="tbl-controlPanel">
                    ...
                    <tr>
                        <td>Department</td>
                        <td>
                            <asp:DropDownList ID="ddlDepartmentList" runat="server" CssClass="input controlLength" ClientIDMode="Static">
