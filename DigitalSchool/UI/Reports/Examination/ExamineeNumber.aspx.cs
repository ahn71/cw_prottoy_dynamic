...
{
    public partial class ExamineeNumber : System.Web.UI.Page
    {
        ...
        protected void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            dt = ExamCommon.getExamineeNumber(BatchClsID[0], BatchClsID[1], ddlExamList.SelectedValue, ddlGroup.SelectedValue, ddlSubjectList.SelectedValue);
            if (dt != null && dt.Rows.Count > 0)
            {
                Session["__ExamineeNumber__"] = dt;
                ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "call me", "goToNewTab('/UI/Reports/CrystalReport/ReportViewer.aspx?for=ExamineeNumber');", true);  //Open New Tab for Sever side code
            }
            else
