...
{
    public partial class SubjectWiseNumberSheet : System.Web.UI.Page
    {
        ...
        protected void ddlBatch_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                Exam.LoadSubjectListWithAll(ddlSubjectList,BatchClsID[1]);
        ...
        protected void ddlGroup_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Exam.LoadSubjectListWithAll(ddlSubjectList, BatchClsID[1], ddlGroup.SelectedValue);
            ClassSectionEntry.GetEntitiesDataWithAll(dlSection, int.Parse(BatchClsID[1]), ddlGroup.SelectedValue);
            ExamInfoEntry.GetExamIdListWithExInSl(ddlExamList, BatchClsID[0], ddlGroup.SelectedItem.Value);
        }
        protected void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            dt = ExamCommon.getNumberSheetInExam(BatchClsID[0], BatchClsID[1],ddlExamList.SelectedValue, ddlGroup.SelectedValue,ddlSubjectList.SelectedValue, dlSection.SelectedValue);
            if (dt != null && dt.Rows.Count > 0)
            {
                Session["__NumberSheetInExam__"] = dt;
                ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "call me", "goToNewTab('/UI/Reports/CrystalReport/ReportViewer.aspx?for=NumberSheetInExam');", true);  //Open New Tab for Sever side code
            }
            else
