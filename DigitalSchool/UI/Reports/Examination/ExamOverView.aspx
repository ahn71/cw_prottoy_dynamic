<%@ Page Title="Exam OverView" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ExamOverView.aspx.cs" Inherits="DS.UI.Reports.Examination.ExamOverView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
     <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">               
                ...
                <li class="active">Exam Overview</li>               
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>  
    ...
    <div class="">
        <div class="tgPanel">
            <div class="tgPanelHead">Exam OverView</div>
            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="form-inline">
                     <div class="form-group">
                          ...
                          OnClientClick="return validateDropDown();"   ClientIDMode="Static" runat="server" OnClick="btnFailSubjectWise_Click" />
                     </div>
                    <div class="form-group">
                         
                             <asp:Button ID="btnGrateInfo" CssClass="btn btn-primary littleMargin" Text="Result Overview"
                         OnClientClick="return validateDropDown();"  ClientIDMode="Static" runat="server" OnClick="btnGrateInfo_Click" />
                     </div>
                    <div class="form-group">
                         
                            <asp:Button ID="btnResultGenderWise" CssClass="btn btn-primary littleMargin" Text="Gender Wise OverView"
                         OnClientClick="return validateDropDown();"   ClientIDMode="Static" runat="server" OnClick="btnResultGenderWise_Click" />
                     </div>
