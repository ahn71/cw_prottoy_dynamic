...
{
    public partial class SeatPlanSticker : System.Web.UI.Page
    {
        ...
        protected void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            dt = ExamCommon.getSeatPlanStricker(BatchClsID[0], BatchClsID[1], ddlExamList.SelectedValue, dlSection.SelectedValue, txtRollNo.Text);
            if (dt != null && dt.Rows.Count > 0)
            {
                Session["__SeatPlanStricker__"] = dt;
                ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "call me", "goToNewTab('/UI/Reports/Examination/ShowSeatPlanSticker.aspx');", true);  //Open New Tab for Sever side code
            }
            else
