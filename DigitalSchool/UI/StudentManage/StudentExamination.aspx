<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="StudentExamination.aspx.cs" Inherits="DS.UI.StudentManage.StudentExamination" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlExamType" runat="server" Width="300px" ClientIDMode="Static"
                         AutoPostBack="true" CssClass="input controlLength" OnSelectedIndexChanged="ddlExamType_SelectedIndexChanged"></asp:DropDownList>
                    </td>
                </tr>
            </table>                        
        </div>       
