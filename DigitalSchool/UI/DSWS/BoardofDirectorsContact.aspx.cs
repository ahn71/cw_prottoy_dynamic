...
{
    public partial class BoardofDirectorsContact : System.Web.UI.Page
    {
        string divInfo = "";
        ...
        private void loadTeacherContacts()
        {
            ...
            ListEntities = emp.getBoardDirectorsCotactList_WS();
            if (ListEntities != null)
            {
                divInfo = "<h2>পরিচালনা পর্ষদ</h2> <div class='row'>";
                ...
                divInfo += " </div>";
                divBoardDirContacts.Controls.Add(new LiteralControl(divInfo));
            }
        }
    }
}