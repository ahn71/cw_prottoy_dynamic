<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="BusInformation.aspx.cs" Inherits="DS.UI.Administration.Settings.AcademicSettings.BusInformation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-4">
                <h4 class="text-right" style="float:left">Bus List</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <asp:HiddenField ID="lblBusId" ClientIDMode="Static" runat="server"/>  
                        <div class="tgPanel">
            ...
            <div class="col-md-6">
                <div class="tgPanel">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="tgPanelHead">Add Bus</div>
                            <table class="tbl-controlPanel">
                                <tr>
                                    <td>Bus Name
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBusName" runat="server" ClientIDMode="Static" CssClass="input form-control"></asp:TextBox>
                                    </td>
                                </tr> 
                                <tr>
                                    <td></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function validateInputs() {
            if (validateText('txtBusName', 1, 100, 'Enter a Bus Name') == false) return false;
            return true;
        }
        function editBuilding(BuildingId) {
            var na = $('#lblBusId').val(BuildingId);
            var strBuildingName = $('#busname' + BuildingId).html();
            $('#txtBusName').val(strBuildingName);
