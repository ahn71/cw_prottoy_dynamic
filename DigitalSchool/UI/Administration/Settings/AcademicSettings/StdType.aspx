<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="StdType.aspx.cs" Inherits="DS.UI.Administration.Settings.AcademicSettings.StdType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Student Type</li>                
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
    <div class="">
        <div class="row">
            ...
            <div class="col-md-4">
                <h4 class="text-right" style="float:left">Student Type</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tgPanel">
                    <div class="tgPanelHead">Add Student Type</div>
                     ...
                     <div class="row tbl-controlPanel">
                        <div class="col-sm-8 col-sm-offset-2">
                              <div class="row tbl-controlPanel">
                                ...
                                <div class="col-sm-8">
                                     <asp:TextBox ID="txtstdtype" runat="server" ClientIDMode="Static" CssClass="input form-control"></asp:TextBox>
                                </div>
                              </div>
                              <div class="row tbl-controlPanel">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function validateInputs() {
            if (validateText('txtstdtype', 1, 50, 'Enter Student Type Name') == false) return false;
            return true;
        }
        function editSection(SecId) {
            $('#lblSectionID').val(SecId);
            var strSec = $('#r_' + SecId + ' td:first-child').html();
            $('#txtstdtype').val(strSec);
            $("#btnSave").val('Update');
        }
        function Cleartext() {
            $('#txtstdtype').val('');
