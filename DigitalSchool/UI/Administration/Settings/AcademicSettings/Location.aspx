<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Location.aspx.cs" Inherits="DS.UI.Administration.Settings.AcademicSettings.Location" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-4">
                <h4 class="text-right" style="float:left">Location Name List</h4>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <asp:HiddenField ID="lblLocationId" ClientIDMode="Static" runat="server"/>  
                        <div class="tgPanel">
            ...
            <div class="col-md-6">
                <div class="tgPanel">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            <div class="tgPanelHead">Add Location Name</div>
                            <table class="tbl-controlPanel">
                                <tr>
                                    <td>Location Name
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtLocationName" runat="server" ClientIDMode="Static" CssClass="input form-control"></asp:TextBox>
                                    </td>
                                </tr> 
                                <tr>
                                    <td></td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function validateInputs() {
            if (validateText('txtLocationName', 1, 50, 'Enter a Location Name') == false) return false;
            return true;
        }
        function editLocation(LocationId) {
            var na = $('#lblLocationId').val(LocationId);
            var strLocationName = $('#locationName' + LocationId).html();
            $('#txtLocationName').val(strLocationName);
