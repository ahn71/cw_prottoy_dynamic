<%@ Page Title="Off Day Settings" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="OffDaysSet.aspx.cs" Inherits="DS.UI.Academic.Timetable.SetTimings.OffDaysSet" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .tbl-controlPanel td:first-child{
          ...
          #tblOffDayList_length {
             display: none;
            padding: 15px;
        }
         #tblOffDayList_filter {
            display: none;
            padding: 15px;
        }
          #tblOffDayList_info {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">   
    ...
    <asp:HiddenField ID="hfDate" ClientIDMode="Static" runat="server" Value=""/>
    <div class="row">
        <div class="col-md-12">
            <!--breadcrumbs start -->
            <ul class="breadcrumb">
 ...
 <%--   <asp:UpdatePanel runat="server" ID="updatepanelFeesSett" UpdateMode="Conditional">
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="ckbAll" />         
        </Triggers>
        <ContentTemplate>--%>
            <div class="">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="text-right" style="float:left">Off Day List</h4>
  ...
  <%--                     <asp:UpdatePanel runat="server" ID="updatepanelFeesSett" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            <div class="row tbl-controlPanel">
                ...
                <div class="col-sm-8">
                    <asp:CheckBox runat="server" ID="ckbAll" Text="All" AutoPostBack="true" OnCheckedChanged="ckbAll_CheckedChanged" />
                    <asp:CheckBoxList runat="server" ClientIDMode="Inherit" CssClass="ckblist" ID="ckbShiftList" AutoPostBack="true" OnSelectedIndexChanged="ckbShiftList_SelectedIndexChanged">
                    </asp:CheckBoxList>
                </div>
            </div>
            <div class="row tbl-controlPanel">
                ...
                <div class="col-sm-8">
                    <asp:TextBox ID="txtDate" runat="server" ClientIDMode="Static" CssClass="input form-control"></asp:TextBox>
            ...
            <div class="row tbl-controlPanel">
                ...
                <div class="col-sm-8">
                    <asp:TextBox ID="txtPurpose" runat="server" ClientIDMode="Static" CssClass="input form-control"
...
<%--              </ContentTemplate>
            ...
            <div id="showWeeklyDay" runat="server" style="display: none;" class="confirmationModal500">
                ...
                <div class="modal-body">
                    <p class="text-danger text-center">Please make sure that those uncheck days are weekend or Holiday</p>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(document).on("keyup", '.Search_New', function () {
                searchTable($(this).val(), 'tblOffDayList', '');
            });
            $('#tblOffDayList').dataTable({
                "iDisplayLength": 10,
        ...
        function editOffDate(offDateId,shiftCount) {           
            ...
            $('#hfDate').val(strOffDate);
            $('#txtPurpose').val(strPurpos);
            $("#btnSave").val('Update');
            $("#hfStatus").val('Update');
            updateInfo(strOffDate, shiftCount);
           
        }
        function updateInfo(strOffDate, shiftCount) {
            $.ajax({
                url: "/UI/Administration/Settings/GeneralSettings/OffDaysSet.aspx/getUpdateInfo",
                data: "{Date: '" + strOffDate + "'}",
                type: "POST",
                dataType: "json",
                ...
                success: function OnSuccess(data) {
                    ...
                    {
                        $("#MainContent_ckbAll").prop('checked', false);
                        for (i = 0; i < shiftCount ; i++)
                        {
                            $("#MainContent_ckbShiftList_" + i + "").prop('checked', false);
                        }                 
                        j = 0;
                        c=0;
                        for (i = 0; i < shiftCount ; i++)
                        {
                           // alert(data.d[i]);
                            //$('#MainContent_ckbShiftList').val(data.d[i]);

                            var val = $("#MainContent_ckbShiftList_" + i + "").val();                            
                            if (data.d[j] == val)
                            {
                                $("#MainContent_ckbShiftList_" + i + "").prop('checked', true);
                                c++;
                            }
                            if (i == shiftCount-1 && j < data.d.length)
                            { i = -1; j++ }
                           // $(".MainContent_ckbAll").selected(false);
                            if(shiftCount==c)
                                $("#MainContent_ckbAll").prop('checked', true);
