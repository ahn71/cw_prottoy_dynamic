<%@ Page Title="Expenses" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="DS.UI.Administration.Finance.Accounts.Expenses" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-7">
                        <h4 class="text-right" style="float:left">Expenses List</h4>
                        ...
                        <asp:UpdatePanel runat="server" ID="updatepanel1" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <div class="tgPanel">
                                    ...
                                    <div class="tgPanelHead">Expenses</div>
                                     ...
                                     <div class="row tbl-controlPanel">
                                        <div class="col-sm-10 col-sm-offset-1">
                                              ...
                                              <div class="row tbl-controlPanel">
                                                <label class="col-sm-4">Expenses Date</label>
                                                <div class="col-sm-8">
                                    ...
                                    <%--<table class="tbl-controlPanel">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlTitle" runat="server" CssClass="input controlLength" ClientIDMode="Static"
                                                    AutoPostBack="false">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>                                                                                                                    
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtAmount" runat="server" ClientIDMode="Static" Text="0" CssClass="input controlLength"></asp:TextBox>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td>Expenses Date
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExDate" runat="server" ClientIDMode="Static" CssClass="input controlLength"></asp:TextBox>
                                                <asp:CalendarExtender Format="dd-MM-yyyy" ID="CalendarExtender1" runat="server" TargetControlID="txtExDate"></asp:CalendarExtender>
                                            </td>
                                        </tr> 
                                        <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="server">
    <script type="text/javascript">     
        ...
        function deleteexpenses(expensesid) {            
            $.ajax({
                url: "/UI/Administration/Finance/Accounts/Expenses.aspx/Delete",
