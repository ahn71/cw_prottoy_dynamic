<%@ Page Title="Student Attendance Details" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="Machine_AttendanceDetails.aspx.cs" Inherits="DS.UI.Academics.Attendance.Student.Machine.Machine_AttendanceDetails" %>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Student Attendance Details</li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
