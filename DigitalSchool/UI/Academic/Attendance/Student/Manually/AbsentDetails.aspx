<%@ Page Title="Attendance Entry By Manually" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="AbsentDetails.aspx.cs" Inherits="DS.UI.Academics.Attendance.Student.Manually.AbsentDetails" %>
        ...
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
               ...
               <%-- <li><a runat="server" href="~/UI/Academic/Attendance/Student/Manually/ManuallyHome.aspx">Student Attendance By Manually</a></li>--%>
                <li class="active">Student Daily Attendance View </li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
