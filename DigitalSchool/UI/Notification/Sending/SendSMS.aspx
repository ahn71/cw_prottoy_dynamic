...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ModalPopupExtender ID="smsReportModal" runat="server" BehaviorID="modalpopup2" CancelControlID="Button6"
        OkControlID="LinkButton1"
        TargetControlID="button7" PopupControlID="showSMSReport" BackgroundCssClass="ModalPopupBG">
    </asp:ModalPopupExtender>
    <div id="showSMSReport" runat="server" style="display: none;" class="confirmationModal500">
        <div class="modal-header">
            <button id="Button6" type="button" class="close white"></button>
            <div class="tgPanelHead">Add SMS Template</div>
        </div>
        <div class="modal-body">
            <asp:Panel ID="SMSReport" runat="server" Height="100%" CssClass="datatables_wrapper" Width="100%" ScrollBars="Auto">
