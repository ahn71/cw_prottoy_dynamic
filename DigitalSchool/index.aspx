<%@ Page Title="" Language="C#" MasterPageFile="~/DSWS.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DS.index" %>
                ...
                <div class="col-md-10">
                    <div class="news-heading">
                        <marquee direction="left" scrollamount="3" behavior="scroll" onmouseover="this.stop()" onmouseout="this.start()">
                                <%--<a runat="server" id="aNewsHeadling" href="#" class="hvr-pop"></a>--%>
                               <div runat="server" id="divImportantNews">
                               </div>
                            </marquee>
                    </div>
                </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div>
						<div>
							<a href="http://sobornojointy.islampurcollege.edu.bd">	<img src="websitedesign/assets/images/slider6.jpg" style="width: 100%"></a>
						</div>
						<div style="position: absolute;bottom: 50px;left: 40px;">
							<a href="http://sobornojointy.islampurcollege.edu.bd" style="background: #f4b336;padding: 15px 25px;border-radius: 3px;font-size: 20px;color: #ffff;font-weight: 700;">সুবর্ণজয়ন্তী কর্নার</a>
						</div>
					</div>
				</div>
			</div>
        ...
        <div class="row"> 
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h2><label runat="server" id="lblPresidentMessageHeader"></label></h2>                     
                        <div class="massage-content">
                           
                            <p class=""><asp:Image runat="server" ID="imgPresident" alt="" Width="150px"/></p>
                            <h5 runat="server" id="hPresidentName"></h5>
                            <span class="msg-desg" ><label runat="server" id="lblPresidentDsg"></label></span>
                            <p class="msg-paragraph" runat="server" id="pPresidentSpeech"></p>
                    ...
                    <div class="col-md-6">
                        <div class="notice">
                            <div class="notice-title">
                                <h2> <label runat="server" id="lblNoticeBoardHeader"></label></h2>
                               
                            </div>
                            <div id="LatestNoticeView" runat="server">
                               
                                <%--<table class='table table-striped table - bordered'><thead><tr><th class='text-center'>Date</th><th>Notice Title</th></tr></thead><tbody><tr><td class='text-center'>22-February-2016</td><td><a href = 'UI/DSWS/NoticeView.aspx?NSL=19' > ইতিহাস</a></td></tr> <tr>< td class='text-center'>23-February-2016</td><td><a href = 'UI/DSWS/NoticeView.aspx?NSL=10019' > ভাল খবর</a></td></tr></ tbody ></ table >--%> 
                            </div>
                            <%--<table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  <tr>
                                    <td class="text-center">2/05/2018</td>
                                    <td><a href="">Makes table more compact by cutting cell padding in half</a></td>
                                    <td class="text-center"><i class="fa fa-eye"></i><br />524</td>
                                  </tr>
                                    <tr>
                                    <td class="text-center">2/05/2018</td>
                                    <td><a href="">Makes table more compact by cutting cell padding in half</a></td>
                    ...
                    <div class="col-md-12">
                        <div class="welcome">
                            ...
                            <div class="callage-content">
                                <h2 id="h1HomeSupject" runat="server"></h2>
                                <p id="pHomeDetails" runat="server"></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="gallery-container">
                        <div class="tz-gallery">
                            ...
                            <div runat="server" class="demo" id="container">
                            </div>
            ...
            <div class="col-md-4">
                <div class="right-site">
                    <div class="massage-box">
                            <h2><label runat="server" id="lblPrincipalMessageHeader"></label></h2>
                            <div class="massage-content">
                                 <p class=""><asp:Image runat="server" ID="imgPrincipal" alt="" Width="150px"/></p>
                                
                                <h5 runat="server" id="hPrincipalName"></h5>
                                <span class="msg-desg"><label runat="server" id="lblPrincipalDsg"></label></span>
                                <p class="msg-paragraph" runat="server" id="pPrincipalSpeech"></p>
                            </div>
                        </div>
                    <%-- <div class="notice">
                        <div class="notice-title">
                        ...
                        <div runat="server" id="LatestNoticeView">
                        </div>
                    </div>--%>
                    ...
                    <div class="notice event">
                        <div class="notice-title">
                            <h2>Event</h2>
                            <div runat="server" id="divEventContainer">
                            </div>

                        </div>
                    </div>

                    <div class="video-gallery notice-title">
                        <h2>Video Gallery</h2>
                        <div class="single-video">
                            <iframe width="100%" height="160" src="https://www.youtube.com/embed/HN8Jt3bepPI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="single-video">
                          <iframe width="100%" height="160" src="https://www.youtube.com/embed/lZXjwkbLER4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        <div class="single-video">
                           <iframe width="100%" height="160" src="https://www.youtube.com/embed/Wb-WDO7FH1k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ForFoterSlider" runat="server">
    ...
    <script src="../../Scripts/jquery.sliphover.min.js"></script>
    <script type="text/javascript">



        ; (function ($) {
            jQuery('#ForFoterSlider_container').sliphover();
            jQuery('#menu-left-menu li').prepend('<img src="http://design.optimalbd.com/gov.school/wp-content/themes/gov-school/images/left-icon.png">');
        })(jQuery);

    </script>
    <script type="text/javascript">
        $(window).load(function () {
            $('#MainContent_slider').nivoSlider();
        });
    </script>
    <script type="text/javascript">
    ...
    <script src="../../Scripts/jquery.calendario.js"></script>
    <script src="../../Scripts/jquery.scrollbox.js"></script>
    <script type="text/javascript">
        //$(function () {

        //    $('.auto_text_slide').scrollbox({
        //        linear: true,
        //        step: 1,
        //        delay: 0,
        //        speed: 50
    ...
    <script type="text/javascript"> $('.pgwMenu').pgwMenu();
	...
	//		var endTime = new Date("29 April 2018 9:56:00 GMT+01:00");	
		var endTime = new Date("17 Mar 2020 00:00:01 GMT+01:00");			
